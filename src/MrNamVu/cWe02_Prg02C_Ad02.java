 ...
 * 
 */
public class cWe02_Prg02C_Ad02 extends JFrame{
	JButton btnA = new JButton("A");
	JButton btnB = new JButton("B");
	int d=0, dx=2, dy=2;
	public cWe02_Prg02C_Ad02(){
		...
		Timer tmAutoMoving = new Timer(50, new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				...
				if(( x1>(getWidth()-btnB.getWidth()))||x1<0){
					dx=-dx;
				}
				
				if(( y1> getHeight()-btnB.getHeight())||(y1<0)){
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		cWe02_Prg02C_Ad02 mainWindow = new cWe02_Prg02C_Ad02();
