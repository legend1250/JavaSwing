	...
	public Calculator() {
		...
		ActionListener btnnum = new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				/*
				 * String a[] = { "btn1", "btn2", "btn3", "btn4", "btn5",
				 * "btn6", "btn7", "btn8", "btn9" }; String b[] = { "1", "2",
				 * "3", "4", "5", "6", "7", "8", "9" };
				 * 
				 * if (arg0.getSource() == btn1) { str = str + b[0];
				 * txtresult.append(str); }
				 */
				JButton btnT = (JButton)arg0.getSource();
				String s1= btnT.getText();
				if( blAppend == true){
					txtresult.setText( txtresult.getText()+ s1);
				}
				else{
